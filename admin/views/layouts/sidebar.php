<div class="sidebar-area" id="sidebar-area">
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu active" data-simplebar>
        <ul class="menu-inner">
            <!-- ==========================================
            MAIN MODULES (All Modules - Real Project Style)
            ========================================== -->
            ...
            <!-- Patient Management -->
            <li class="menu-item">
                <a href="?page=patients/manage" class="menu-link">
            ...
            <!-- Doctor Management -->
            <li class="menu-item">
                <a href="?page=doctors/manage" class="menu-link">
            ...
            <li class="menu-item">
                <a href="?page=appointments/manage" class="menu-link">
            ...
            <li class="menu-item">
                <a href="?page=prescriptions/manage" class="menu-link">
